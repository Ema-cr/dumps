...
--
-- Host: 127.0.0.1    Database: cakeboss
-- ------------------------------------------------------
...
CREATE TABLE `pedido` (
  ...
  CONSTRAINT `pedido_ibfk_3` FOREIGN KEY (`id_repartidor`) REFERENCES `repartidor` (`id_repartidor`)
...
-- Dump completed on 2025-07-28 19:00:11
